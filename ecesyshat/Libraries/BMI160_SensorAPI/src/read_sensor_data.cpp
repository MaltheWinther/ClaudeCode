// #include "read_sensor_data.hpp"
// //*********************************************************************/
// /* functions */
// /*********************************************************************/
//
// /* Glue for i2c_wrapper*/
// static I2C_Wrapper *g_i2c = nullptr;
//
// static int8_t bmi_write_cb(uint8_t dev, uint8_t reg, const uint8_t *buf,
//                            uint16_t len) {
//   return g_i2c->ref_write(dev, reg, buf, len);
// }
//
// static int8_t bmi_read_cb(uint8_t dev, uint8_t reg, uint8_t *buf,
//                           uint16_t len) {
//   return g_i2c->ref_read(dev, reg, buf, len);
// }
//
// static void bmi_delay_cb(uint32_t ms) { g_i2c->i2c_delayMicroseconds(ms); }
//
// /*!
//  *  @brief This internal API is used to initialize the sensor interface
//  * depending on selection either SPI or I2C.
//  *
//  *  @param[in] void
//  *
//  *  @return void
...
//   // coines_set_pin_config(COINES_SHUTTLE_PIN_15, COINES_PIN_DIRECTION_OUT,
...
//   // coines_set_pin_config(COINES_SHUTTLE_PIN_7, COINES_PIN_DIRECTION_OUT,
...
//
// /*!
//  *  @brief Main Function where the execution getting started to test the
//  code.
//  *
//  *  @param[in] argc
//  *  @param[in] argv
...
// //            " 3. Check if board is in use by another application.
// //            (Insufficient " "permissions to access USB) \n");
// //     exit(rslt);
// //   }
// //
